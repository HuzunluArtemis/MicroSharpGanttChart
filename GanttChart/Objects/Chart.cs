...
namespace GanttChart
{
    public class Chart : UserControl
    {
        ...
        private void Init()
        {
            ...
            NowIndicatorTimer = new System.Timers.Timer() { Interval = 1000 };
        ...
        private Timer doubleClickTimer = new Timer() { Interval = 40 };
        ...
        /// <summary>
        /// <para>Indıcator top triangle</para>
        /// </summary>
        [Category("Gantt Chart")]
        public bool indicatorTopTriangle
        {
            get { return renderer.indicatorTopTriangle; }
            set { renderer.indicatorTopTriangle = value; }
        }

        /// <summary>
        /// <para>Indıcator bottom triangle</para>
        /// </summary>
        [Category("Gantt Chart")]
        public bool indicatorBottomTriangle
        {
            get { return renderer.indicatorBottomTriangle; }
            set { renderer.indicatorBottomTriangle = value; }
        }

        /// <summary>
        /// <para>Indıcator color</para>
        /// </summary>
        [Category("Gantt Chart")]
        public Color indicatorColor
        {
            get { return renderer.indicatorColor; }
            set { renderer.indicatorColor = value; }
        }
