...
namespace GanttChart
{
    public class Renderer
    {
        ...
        private void InitDefaultValues()
        {
            ...
            indicatorBottomTriangle = true;
            indicatorTopTriangle = true;
        ...
        private void DrawNowIndicator(int startY, int endY)
        {
            ...
            graphics.DrawLine(new Pen(indicatorColor), topPoint, bottomPoint);

            if (indicatorTopTriangle)
            {
                //Draw top triangle
                ...
                graphics.FillPolygon(new SolidBrush(indicatorColor), new[] { t1, t2, t3 });
            }


            if (indicatorBottomTriangle)
            {
                ...
                graphics.FillPolygon(new SolidBrush(indicatorColor), new[] { b1, b2, b3 });
            }
        ...
        public bool indicatorTopTriangle { get; set; }
        public bool indicatorBottomTriangle { get; set; }
