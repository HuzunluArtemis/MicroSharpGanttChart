...
namespace MicroSharpGanttChart.HelperFuncs
{
    internal static class StringFuncs
    {
        ...
        internal static void UnselectTextbox(TextBox textBox) => textBox.Select(0, 0);
        internal static void SelectAllTextBox(TextBox textBox) => textBox.SelectAll();
        internal static void UnselectTextbox(RichTextBox textBox) 
        {
            textBox.EnableContextMenu(); textBox.Select(0, 0);
        }

        #endregion unselect textbox

        internal static string TrimStart(string inputText, string value,
        ...
        internal static string TrimEnd(string inputText, string value,
            StringComparison comparisonType = StringComparison.CurrentCultureIgnoreCase)
        {
            if (!string.IsNullOrEmpty(value))
        ...
        internal static string Trim(string inputText, string value,
            StringComparison comparisonType = StringComparison.CurrentCultureIgnoreCase)
        {
        ...
        {
            return value.Replace("\"Icon\":\"System.Drawing.Bitmap\",", string.Empty);
        }
